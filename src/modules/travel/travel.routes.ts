...
router.get(
  ...
  v.tripIdValidator,
  v.validateWebRequest("/users/app/travels"),
  asyncHandler(app.getAppTravelDetail)
);
router.get(
...
router.patch("/travels/:tripId", authenticate, v.updateTripValidator, v.validateRequest, asyncHandler(api.patchTrip));
router.delete("/travels/:tripId", authenticate, v.tripIdValidator, v.validateRequest, asyncHandler(api.removeTrip));
router.post("/travels/:tripId/stages", authenticate, v.addStageValidator, v.validateRequest, asyncHandler(api.postStage));
router.delete(
